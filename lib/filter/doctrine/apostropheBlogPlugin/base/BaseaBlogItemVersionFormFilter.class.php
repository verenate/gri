...
/**
 * aBlogItemVersion filter form base class.
 *
 * @package    asandbox
 * @subpackage filter
 ...
 */
abstract class BaseaBlogItemVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('a_blog_item_version_filters[%s]');
