...
/**
 * aBlogEventVersion filter form base class.
 *
 * @package    asandbox
 * @subpackage filter
 ...
 */
abstract class BaseaBlogEventVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('a_blog_event_version_filters[%s]');
