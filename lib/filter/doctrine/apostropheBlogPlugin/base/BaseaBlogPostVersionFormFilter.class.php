...
/**
 * aBlogPostVersion filter form base class.
 *
 * @package    asandbox
 * @subpackage filter
 ...
 */
abstract class BaseaBlogPostVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('a_blog_post_version_filters[%s]');
